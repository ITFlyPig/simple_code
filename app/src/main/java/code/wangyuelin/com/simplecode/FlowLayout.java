...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int iWidthSpecSize = MeasureSpec.getSize(widthMeasureSpec);//父容器的建议值
        int iHeightSpecSize = MeasureSpec.getSize(heightMeasureSpec);//父容器的建议值
        ...
        if(iWidthMode == MeasureSpec.EXACTLY && iHeightMode == MeasureSpec.EXACTLY){
            ...
            for(int i = 0 ; i < childCount ; i++){
                ...
                MarginLayoutParams layoutParams = (MarginLayoutParams) childView.getLayoutParams();//获取测量后的值
